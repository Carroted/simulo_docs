...
Sets whether controls are enabled. This is separate from the visual "Enable Controls" toggle.

---

### \:get_controls_enabled()

Gets whether controls are enabled. This is separate from the visual "Enable Controls" toggle.
